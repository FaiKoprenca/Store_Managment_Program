...
public class DateChoiceBox {
    ...
    public static void setDateChoiceBox(Label dateLabel, Label yearLabel, ChoiceBox<String> yearChoiceBox, Label monthLabel, ChoiceBox<String> monthChoiceBox, Label dayLabel, ChoiceBox<String> dayChoiceBox, Label dateErrLabel,
